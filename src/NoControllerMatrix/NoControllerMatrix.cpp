...
NoControllerMatrix::NoControllerMatrix(int rp[8], int cp[8]) {
...
void NoControllerMatrix::setMatrix(bool matrix[8][8]) {
...
void NoControllerMatrix::initMatrix(){
    for(int pin = 0; pin < 8; pin++){
...
void NoControllerMatrix::resetMatrix(){
    for(int pin = 0; pin < 8; pin++){
